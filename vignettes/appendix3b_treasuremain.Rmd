...
Succeeded with that, but then realised should be just a few changes to lines of code to make the N blocks optional, and so use same script for 2 or 4 blocks.
...
for (bl in 1:length(allblock)){
  ...
  for (i in 1:length(alln)){
    ...
    powersummary$subj_rho[thisrow]<-datlist[[16]][1] #just 1st value; we won't be setting this!
